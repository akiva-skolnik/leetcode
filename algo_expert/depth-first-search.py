...
def test():
    tests = [{'expected': ['A', 'B', 'C', 'D'],
              'graph': {'nodes': [{'children': ['B', 'C', 'D'], 'id': 'A', 'value': 'A'},
             ...
             {'expected': ['A', 'B', 'C', 'D', 'E'],
              'graph': {'nodes': [{'children': ['B', 'C', 'D', 'E'],
                        ...
                        'startNode': 'A'}},
             {'expected': ['A', 'B'],
              'graph': {'nodes': [{'children': ['B'], 'id': 'A', 'value': 'A'},
             ...
             {'expected': ['A', 'B', 'C', 'D', 'E', 'F'],
              'graph': {'nodes': [{'children': ['B', 'C', 'D', 'E', 'F'],
                                   'id': 'A',
                                   'value': 'A'},
                        ...
                        'startNode': 'A'}}]
    for test in tests:
        tree = build_tree(test['graph'])
        assert tree.depthFirstSearch([]) == test['expected']
